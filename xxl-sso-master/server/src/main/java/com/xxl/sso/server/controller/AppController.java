...
public class AppController {
    ...
    public ReturnT<String> login(String username, String password) {
        ...
        if (existUser == null) {
            return new ReturnT<String>(ReturnT.USER_NOT_EXIST, "username is invalid.");
        }
        ...
        // result
        return new ReturnT<String>(sessionId,"success");
    }
    ...
    public ReturnT<XxlUser> logincheck(String sessionId) {
        ...
        if (xxlUser == null) {
            return new ReturnT<XxlUser>(ReturnT.TOKEN_IS_INVALID, "token is invalid.");
        }
        return new ReturnT<XxlUser>(xxlUser,"auth success");
    }
